...
An unrecognized type is a 400 naming the accepted types. `work_value_change` had no server mapping and was being filed as a payment; it is removed from `static/rent.html` and the client formatter rather than left selectable and misfiling.
